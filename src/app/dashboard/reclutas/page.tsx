...
export default async function ReclutasPage() {
  ...
  // Solo rangos 9 o superior
  if (user.rank.order > 9) {
    redirect('/dashboard')
  }
    ...
    <div className="min-h-screen pt-20 px-4 pb-4 sm:pt-24 sm:px-6 sm:pb-6 lg:px-8 lg:pb-8" style={{ backgroundColor: '#0f0f0f' }}>
      <div className="max-w-7xl mx-auto">
        ...
        >
          ...
          >
            Aquí podrás gestionar y capacitar a los nuevos miembros del clan.
          </p>
          <p
